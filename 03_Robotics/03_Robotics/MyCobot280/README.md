...
The objective is to understand robot programming, motion control and human-machine interaction using Python.
...
- Work with joint angles
- Create reusable movement functions
- Experiment with computer vision integration
